...
- Name: homepage.spec.js >> 3. Telugu Mode — i18n >> 3.6 Location section shows Telugu heading
- Location: src\tests\e2e\homepage.spec.js:153:3
...
Locator: locator('text=మమ్మల్ని కనుగొనండి').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=మమ్మల్ని కనుగొనండి').first()
