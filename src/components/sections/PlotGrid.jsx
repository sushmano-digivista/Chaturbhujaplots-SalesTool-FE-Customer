                      ...
                      >
                        ...
                        {data.plotNumbers?.length > 0 && (
                          <>
                            ...
                            {/* Status legend removed — all plots shown uniformly */}
                            ...
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 5 }}>
                              {/* All plots shown in original order, no status sorting */}
                              {data.plotNumbers.map((num, idx) => {
                                ...
                                // Pulse the first 3 chips until user has clicked one
                                  ...
                                  <span key={num} style={{ position: 'relative', display: 'inline-block' }}>
                                    <button
                                      ...
                                      onClick={(e) => {
                                        ...
                                        if (nextOpen) trackPlotClicked(ventureKey, num, 'available')
                                      ...
                                      style={{
                                        background: isOpenPlot ? chipAccent : gradBase,
                                        color:        isOpenPlot ? '#fff' : '#1E4D2B',
                                        border:       isOpenPlot ? '1px solid ' + chipAccent : borderBase,
                                        borderRadius: 8,
                                        padding: '6px 14px',
                                        fontSize: 18,
                                        fontWeight: 700,
                                    ...
                                    >{num}</button>
                                    {/* SOLD badge overlay removed — status no longer shown */}
                                    {isOpenPlot && (
