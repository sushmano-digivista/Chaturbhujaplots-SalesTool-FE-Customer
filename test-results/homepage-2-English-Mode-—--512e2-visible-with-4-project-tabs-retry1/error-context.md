            ...
            - iframe [ref=e714]:
              - generic [ref=f2e6]:
                ...
                - generic [ref=f2e8]:
                  ...
                  - button "Map camera controls" [ref=f2e44] [cursor=pointer]
                  - button "Show satellite imagery" [ref=f2e47] [cursor=pointer]:
                    - generic [ref=f2e51]:
                      - region [ref=f2e52]
                      - iframe [ref=f2e57]:
                        
                  - img "Google" [ref=f2e59]
                  - generic [ref=f2e60]:
                    - button "Keyboard shortcuts" [ref=f2e66] [cursor=pointer]
                    - generic [ref=f2e71]: Map data ©2026
                    - link "Terms (opens in new tab)" [ref=f2e76] [cursor=pointer]:
                      - /url: https://www.google.com/intl/en-US_US/help/terms_maps.html
                      - text: Terms
                    - link "Report a map error" [ref=f2e81] [cursor=pointer]:
            ...
            - iframe [ref=e715]:
              - generic [ref=f3e6]:
                ...
                - generic [ref=f3e8]:
                  ...
                  - button "Map camera controls" [ref=f3e59] [cursor=pointer]
                  - button "Show satellite imagery" [ref=f3e62] [cursor=pointer]:
                    - generic [ref=f3e66]:
                      - region [ref=f3e67]
                      - iframe [ref=f3e72]:
                        
                  - img "Google" [ref=f3e74]
                  - generic [ref=f3e75]:
                    - button "Keyboard shortcuts" [ref=f3e81] [cursor=pointer]
                    - generic [ref=f3e86]: Map data ©2026
                    - link "Terms (opens in new tab)" [ref=f3e91] [cursor=pointer]:
                      - /url: https://www.google.com/intl/en-US_US/help/terms_maps.html
                      - text: Terms
                    - link "Report a map error" [ref=f3e96] [cursor=pointer]:
