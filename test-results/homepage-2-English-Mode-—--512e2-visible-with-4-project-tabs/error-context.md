...
- Name: homepage.spec.js >> 2. English Mode — Content >> 2.6 Location section visible with 4 project tabs
- Location: src\tests\e2e\homepage.spec.js:99:3
...
Call log:
  ...
  - waiting for locator('text=Anjana Paradise').first()
    8 × locator resolved to <div class="_mobileProjectName_wldic_703">Anjana Paradise</div>
              ...
              - generic [active] [ref=f1e1]:
                ...
                - generic [ref=f1e13]:
                  ...
                  - generic [ref=f1e15]:
                    ...
                    - img "Google" [ref=f1e72]
                    - generic [ref=f1e73]:
                      - button "Keyboard shortcuts" [ref=f1e79] [cursor=pointer]
                      - generic [ref=f1e84]: Map data ©2026
                      - link "Terms (opens in new tab)" [ref=f1e89] [cursor=pointer]:
              ...
              - generic [active] [ref=f3e1]:
                ...
                - generic [ref=f3e13]:
                  ...
                  - generic [ref=f3e15]:
                    ...
                    - img "Google" [ref=f3e81]
                    - generic [ref=f3e82]:
                      - button "Keyboard shortcuts" [ref=f3e88] [cursor=pointer]
                      - generic [ref=f3e93]: Map data ©2026
                      - link "Terms (opens in new tab)" [ref=f3e98] [cursor=pointer]:
                        - /url: https://www.google.com/intl/en-US_US/help/terms_maps.html
                        - text: Terms
                      - link "Report a map error" [ref=f3e103] [cursor=pointer]:
            ...
            - iframe [ref=e716]:
              - generic [ref=f4e3]:
                ...
                - generic [ref=f4e5]:
                  ...
                  - img "Google" [ref=f4e76]
                  - generic [ref=f4e77]:
                    - button "Keyboard shortcuts" [ref=f4e83] [cursor=pointer]
                    - generic [ref=f4e88]: Map data ©2026
                    - link "Terms (opens in new tab)" [ref=f4e93] [cursor=pointer]:
                      - /url: https://www.google.com/intl/en-US_US/help/terms_maps.html
                      - text: Terms
                    - link "Report a map error" [ref=f4e98] [cursor=pointer]:
...
```ts
  ...
  2   | 
  3   | // ─────────────────────────────────────────────────────────────────────────────
  4   | // Chaturbhuja Properties — End-to-End Test Suite
  5   | // Covers: EN + TE language, all sections, project pages, modals, forms
  6   | // ─────────────────────────────────────────────────────────────────────────────
  7   | 
  8   | const BASE = 'http://127.0.0.1:3000'
  9   | 
  10  | // ── Helpers ──────────────────────────────────────────────────────────────────
  11  | async function switchToTelugu(page) {
  12  |   const toggle = page.locator('button:has-text("EN"), button:has-text("తె"), [class*="langToggle"], [class*="LanguageToggle"]').first()
  13  |   const text = await toggle.textContent()
  14  |   if (text?.includes('EN')) await toggle.click()
  15  |   await page.waitForTimeout(500)
  16  | }
  17  | 
  18  | async function switchToEnglish(page) {
  19  |   const toggle = page.locator('button:has-text("EN"), button:has-text("తె"), [class*="langToggle"], [class*="LanguageToggle"]').first()
  20  |   const text = await toggle.textContent()
  21  |   if (text?.includes('తె')) await toggle.click()
  22  |   await page.waitForTimeout(500)
  23  | }
  24  | 
  25  | // ══════════════════════════════════════════════════════════════════════════════
  26  | // SUITE 1 — Page Load & Core Structure
  27  | // ══════════════════════════════════════════════════════════════════════════════
  28  | test.describe('1. Page Load & Core Structure', () => {
  29  |   test('1.1 Homepage loads with 200 status', async ({ page }) => {
  30  |     const res = await page.goto(BASE)
