...
- Name: homepage.spec.js >> 3. Telugu Mode — i18n >> 3.3 Why Chaturbhuja shows Telugu
- Location: src\tests\e2e\homepage.spec.js:140:3
...
Locator: locator('text=మాతో ఎందుకు').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=మాతో ఎందుకు').first()
