...
Locator: locator('button:has-text("అందుబాటులోని"), button:has-text("ఇప్పుడే")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("అందుబాటులోని"), button:has-text("ఇప్పుడే")').first()
